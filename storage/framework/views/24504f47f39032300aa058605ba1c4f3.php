<nav class="navbar navbar-expand-lg navbar-dark shadow-sm">
    <div class="container-fluid px-3 px-md-4">
        <a class="navbar-brand fw-bold d-flex align-items-center" href="<?php echo e(route('dashboard')); ?>">
            ...
            <span class="d-none d-sm-inline"><?php echo e(config('app.name')); ?></span>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <span class="d-none d-lg-inline"><?php echo e(\Illuminate\Support\Str::limit(auth()->user()->name, 15)); ?></span>
                    </a>
...
<?php /**PATH /Users/hassankhosrojerdi/Desktop/ERP/resources/views/layouts/navbar.blade.php ENDPATH**/ ?>